        ...
        <div className='mx-auto max-w-4xl py-32'>
          ...
          <div className='text-center'>
            ...
            <p className='mt-6 text-lg leading-8 text-gray-600'>
              Medileaf is an application whose motive is to help the individual
              to identify medicinal plant with their properties by just scanning
              the leaf of any plant which might result creating curiosity about
              plant that lead to the preservation of the valuable plants as well
              as source of income.
            </p>
